...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [HeaderComponent, MenuComponent, CommonModule, LucideAngularModule, CardComponent],
  ...
  animations: [
    trigger('menuAnim', [
      ...
      transition(':leave', [
        animate('300ms ease-in-out', style({ opacity: 0, transform: 'translateX(-250px)' }))
      ])
    ])
  ]
})
